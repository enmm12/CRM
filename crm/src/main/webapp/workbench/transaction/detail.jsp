	...
	function changeStage(stage,i) {
		...
		$.ajax({
			...
			success : function(data){
				...
				//data {"success":true/false,"t":{一条交易}}
				if(data.success){
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			//判断当前阶段
			//如果当前阶段可能性为0，则前七个一定是黑圈，后两个一个红叉，一个黑叉
        ...
        //如果当前阶段可能性不为0，最后两个为黑叉，前七个可能是，绿圈，黑圈，绿色标记
        }else{
    ...
    -------------%>
    <span class="closingDate"><%=time%></span>
</div>
