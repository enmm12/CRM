...
<body>
	...
	<form class="form-horizontal" role="form" id="tranForm" method="post" action="workbench/transaction/save.do" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="2d10cfd0efad43adb89115ab0c28ff51" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="a4ca7eb6a01c474a96555631c567b12e" name="contactsId">
			</div>
		</div>
